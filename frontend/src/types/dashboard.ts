...
export type Kpis = {
  ...
  // Added for AI model prediction reliability.
  // Backend teammate: populate this field from the forecast evaluation module.
  // When present, the Overview card switches from demo data to the live value.
