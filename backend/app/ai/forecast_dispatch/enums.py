...
class RouteEnum(str, Enum):
    A_DIRECT_ROAD = "A_DIRECT_ROAD"
    B_ROAD_VIA_CT = "B_ROAD_VIA_CT"
    C_WATER_ROAD_VIA_CT = "C_WATER_ROAD_VIA_CT"
    D_WATER_VIA_CT = "D_WATER_VIA_CT"
    E_ROAD_WATER_VIA_CT = "E_ROAD_WATER_VIA_CT"
...
AI1_ROUTE_TO_AI2_ROUTE: dict[str, tuple[RouteEnum, Mode | None, Mode]] = {
    "A_DIRECT_ROAD": (RouteEnum.A_DIRECT_ROAD, None, Mode.ROAD),
    "B_ROAD_VIA_CT": (RouteEnum.B_ROAD_VIA_CT, Mode.ROAD, Mode.ROAD),
    "C_WATER_ROAD_VIA_CT": (RouteEnum.C_WATER_ROAD_VIA_CT, Mode.WATER, Mode.ROAD),
    "D_WATER_VIA_CT": (RouteEnum.D_WATER_VIA_CT, Mode.WATER, Mode.WATER),
    "E_ROAD_WATER_VIA_CT": (RouteEnum.E_ROAD_WATER_VIA_CT, Mode.ROAD, Mode.WATER),
}

# Route nào cần AI2 xử lý (loại trừ A_DIRECT_ROAD, theo phạm vi trách nhiệm AI2-plan.pdf mục 2).
ROUTES_REQUIRING_AI2 = {
    RouteEnum.B_ROAD_VIA_CT,
    RouteEnum.C_WATER_ROAD_VIA_CT,
    RouteEnum.D_WATER_VIA_CT,
    RouteEnum.E_ROAD_WATER_VIA_CT,
}
